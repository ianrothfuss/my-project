...
var BuildId = "wvBGLAlDXXcdCN3K-SSI_";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/(app)/next/preview/route": "/next/preview", "/(app)/next/exit-preview/route": "/next/exit-preview", "/(app)/next/seed/route": "/next/seed", "/(payload)/api/graphql/route": "/api/graphql", "/(payload)/api/graphql-playground/route": "/api/graphql-playground", "/(payload)/api/[...slug]/route": "/api/[...slug]", "/(app)/page": "/", "/(app)/products/[slug]/page": "/products/[slug]", "/(app)/checkout/confirm-order/page": "/checkout/confirm-order", "/(app)/checkout/page": "/checkout", "/(app)/logout/page": "/logout", "/(app)/find-order/page": "/find-order", "/(app)/login/page": "/login", "/(payload)/admin/[[...segments]]/page": "/admin/[[...segments]]", "/(app)/create-account/page": "/create-account", "/(app)/forgot-password/page": "/forgot-password", "/(app)/(account)/orders/[id]/page": "/orders/[id]", "/(app)/(account)/account/addresses/page": "/account/addresses", "/(app)/(account)/orders/page": "/orders", "/(app)/(account)/account/page": "/account", "/(app)/shop/page": "/shop", "/(app)/[slug]/page": "/[slug]" };
