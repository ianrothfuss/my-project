...
var BuildId = "mUDinmGA_hnBvlNymUfLE";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/(app)/next/exit-preview/route": "/next/exit-preview", "/(app)/next/preview/route": "/next/preview", "/(app)/next/seed/route": "/next/seed", "/(payload)/api/graphql-playground/route": "/api/graphql-playground", "/(payload)/api/graphql/route": "/api/graphql", "/(payload)/api/[...slug]/route": "/api/[...slug]", "/(payload)/admin/[[...segments]]/page": "/admin/[[...segments]]", "/(app)/page": "/", "/(app)/find-order/page": "/find-order", "/(app)/[slug]/page": "/[slug]", "/(app)/checkout/confirm-order/page": "/checkout/confirm-order", "/(app)/forgot-password/page": "/forgot-password", "/(app)/create-account/page": "/create-account", "/(app)/logout/page": "/logout", "/(app)/checkout/page": "/checkout", "/(app)/products/[slug]/page": "/products/[slug]", "/(app)/login/page": "/login", "/(app)/(account)/orders/[id]/page": "/orders/[id]", "/(app)/(account)/account/addresses/page": "/account/addresses", "/(app)/(account)/account/page": "/account", "/(app)/(account)/orders/page": "/orders", "/(app)/shop/page": "/shop" };
